...
<script defer src="js/modiValidacion.js"></script>
				...
				<nav class="navbar navbar-expand-lg navbar navbar-light"
					...
					<div class="collapse navbar-collapse" id="navbarText">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item"><a class="nav-link active" href="#">Modificar</a></li>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 border seccion rounded">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6  " style="margin-top: 12vh">
						<%
						...
						<form class="border border-primary rounded" id="formulario"
							...
							<fieldset>
								<legend class="text-center">Modificar Precio</legend>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="precio_id"
										name="precio" placeholder="25.61" /> <small>Error
										message</small>
								</div>
								...
								<div class="form-group text-center">
									...
									<button type="submit" class="btn btn-dark" id="btn-mod">Modificar</button>
