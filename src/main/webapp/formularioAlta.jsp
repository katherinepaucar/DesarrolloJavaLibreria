...
<script defer src="js/validacionV1.js"></script>
				...
				<nav class="navbar navbar-expand-lg navbar navbar-light"
					...
					<div class="collapse navbar-collapse" id="navbarText">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item"><a class="nav-link active" href="#">Alta</a></li>
							<li class="nav-item"><a class="nav-link"
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-8 col-sm-6">
						<div class="text-center">
							...
							%>
							<div class="text-center textoMensaje" style="margin-top:20px">
						...
						<form class="border  border-primary rounded" id="formulario"
							name="formulario" action="LibrosServlet" method="post">
							<fieldset>
								<legend class="text-center">Alta libro</legend>
								...
								<div class="form-group">
									...
									<label for="titulo_id" class="control-label">Título</label> <input
										type="text" class="form-control" id="titulo_id" name="titulo"
										placeholder="Las flores" /> <small>Error message</small>
								</div>

								<div class="form-group">
									<!-- Autor -->
									<label for="autor_id" class="control-label">Autor</label> <input
										type="text" class="form-control" id="autor_id" name="autor"
										placeholder="Autor" /> <small>Error message</small>
								</div>
								<div class="form-group">
									<!-- Editorial -->
									<label for="editorial_id" class="control-label">Editorial</label>
									<input type="text" class="form-control" id="editorial_id"
										name="editorial" placeholder="Suma de Letras" /> <small>Error
										message</small>
								</div>
								...
								<div class="form-group">
									...
									<label for="isbn_id" class="control-label">ISBN</label> <input
										...
										placeholder="9783161484100" /> <small>Error message</small>
								</div>

								<div class="form-group">
									<!-- Precio-->
									<label for="precio_id" class="control-label">Precio(€)</label>
									<input type="text" class="form-control" id="precio_id"
										name="precio" placeholder="25.65" /> <small>Error
										message</small>
								</div>
								<div class="form-group">
									<!-- Publicacion-->
									<label for="publicacion_id" class="control-label">Publicación(indicar
										año)</label> <input type="text" class="form-control"
										id="publicacion_id" name="publicacion" placeholder="1991" /> <small>Error
										message</small>
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="descrip"
										placeholder="Introduce una descripción" name="descripcion"></textarea>
